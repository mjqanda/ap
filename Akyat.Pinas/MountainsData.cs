...
namespace Akyat.Pinas
{
    public class MountainsData
    {
        ...
        //            ImgDesc00 = "Authorities decided to close Mt. Apo for an indefinite period to mountaineering and related activities amid a fire that continues to rage in the country's tallest peak. ... He said a new aerial survey showed the fire has spread from the northeast side of the mountain to its east and southeast sides.(Apr 2, 2016)",
        ...
        //            ImgDesc00 = "The DENR-PAMB of Mts. Palay-Palay/Mataas na Gulod National Park in Cavite has announced that Pico de Loro will be closed to hiking activities starting October 1, 2016 for planning and rehabilitation. The closure is indefinite and applies to all trails.",
