...
namespace WeatherInfo
{
    public class ForecastAdapterClass : BaseAdapter
    {
        ...
        private WeatherAct weatherAct;
        private List<Forecast> lstForeCast;
        ...
        public ForecastAdapterClass(WeatherAct weatherAct, List<Forecast> lstForeCast)
        {
            this.weatherAct = weatherAct;
