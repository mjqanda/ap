...
{
    [Activity(Theme = "@style/Theme.NoTitle", Label = "balagbagAct")]
    public class balagbagAct : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.balagbagLayout);
